...
const ENTRIES: EntryDefinition[] = [
  // ===== УК Сердце Ростова =====
  {
    ...
    contacts: [
      {
        type: "phone",
        value: "+7 (960) 448-08-18",
        label: "Диспетчерcкая УК",
        isPrimary: true,
        hasWhatsApp: true,
        is24h: true,
        tagIds: ["tag-dispetcher"],
      },
      {
        type: "phone",
        value: "+7 (906) 453-40-97",
      ...
      {
        type: "phone",
        value: "+7 (960) 461-44-60",
        label: "Директор по работе с населением",
        subtitle: "Сергей Григорьевич Сагиров",
        hasWhatsApp: true,
      },
      {
        type: "phone",
        value: "+7 (960) 448-58-08",
        label: "Директор",
      ...
      {
        type: "phone",
        value: "+7 (903) 403-09-30",
        label: "Расчетный отдел",
        subtitle: "Бухгалтерия",
        hasWhatsApp: true,
        scheduleNote: "Пн-Пт 9:00-18:00",
      },
      {
        type: "address",
        value: "г. Ростов-на-Дону, пр. Михаила Нагибина, 33а/47, этаж 3, офис 306",
        tagIds: ["tag-address"],
      },
  ...
  // ===== АВАРИЙНЫЕ СЛУЖБЫ =====
  {
    ...
    contacts: [
      {
        type: "phone",
        value: "+7 (960) 448-00-98",
        label: "Аварийно-диспетчерская служба",
        isPrimary: true,
        is24h: true,
        tagIds: ["tag-dispetcher"],
      },
      ...
      {
        type: "phone",
        value: "+7 (938) 155-22-37",
        label: "Сантехник",
        subtitle: "Андрей Юрьевич",
        is24h: true,
        tagIds: ["tag-santehnik"],
      },
      {
        type: "phone",
        value: "+7 (961) 402-84-63",
        label: "Сантехник",
      ...
      {
        type: "phone",
        value: "+7 (989) 518-97-37",
        label: "Тепловой пункт",
      ...
      {
        type: "phone",
        value: "+7 (928) 152-12-12",
        label: "Застройщик - ООО МСК-СТРОЙ",
        subtitle: "Прораб Стрекалов Игорь",
      },
      {
        type: "phone",
        value: "+7 (863) 297-56-01",
        label: "Ворота",
      ...
      {
        type: "telegram",
        value: "https://t.me/serdcerostova2",
        label: "Telegram - Общий чат",
        tagIds: ["tag-chat"],
      },
  ...
  // ===== ЗДАНИЯ (Строения 1-7) =====
  {
    ...
    contacts: [
      {
        type: "phone",
        value: "+7 (960) 461-44-24",
        label: "Консьерж - подъезд 1",
        tagIds: ["tag-konsierzh", "tag-stroenie-1", "tag-podezd-1"],
      },
      {
        type: "phone",
        value: "+7 (960) 461-44-25",
        label: "Консьерж - подъезд 2",
        tagIds: ["tag-konsierzh", "tag-stroenie-1", "tag-podezd-2"],
      },
      {
        type: "telegram",
        value: "https://t.me/sr2_s1",
        label: "Telegram - Строение 1",
        tagIds: ["tag-chat", "tag-stroenie-1"],
      },
      {
        type: "address",
        value: "г. Ростов-на-Дону, ул. Ларина, д.45, строение 1",
        tagIds: ["tag-address", "tag-stroenie-1"],
      },
    ],
  ...
  },
  {
    ...
    contacts: [
      {
        type: "phone",
        value: "+7 (960) 461-44-21",
        label: "Консьерж - подъезд 1",
        tagIds: ["tag-konsierzh", "tag-stroenie-2", "tag-podezd-1"],
      },
      {
        type: "phone",
        value: "+7 (960) 461-44-32",
        label: "Консьерж - подъезд 2",
        tagIds: ["tag-konsierzh", "tag-stroenie-2", "tag-podezd-2"],
      },
      {
        type: "telegram",
        value: "https://t.me/sr2_s2",
        label: "Telegram - Строение 2",
        tagIds: ["tag-chat", "tag-stroenie-2"],
      },
      {
        type: "address",
        value: "г. Ростов-на-Дону, ул. Ларина, д.45, строение 2",
        tagIds: ["tag-address", "tag-stroenie-2"],
      },
    ],
  ...
  },
  {
    ...
    contacts: [
      {
        type: "telegram",
        value: "https://t.me/sr2_s3",
        label: "Telegram - Строение 3",
        tagIds: ["tag-chat", "tag-stroenie-3"],
      },
      {
        type: "address",
        value: "г. Ростов-на-Дону, ул. Ларина, д.45, строение 3",
        tagIds: ["tag-address", "tag-stroenie-3"],
      },
    ],
  ...
  },
  {
    ...
    contacts: [
      {
        type: "telegram",
        value: "https://t.me/sr2_s4",
        label: "Telegram - Строение 4",
        tagIds: ["tag-chat", "tag-stroenie-4"],
      },
      {
        type: "address",
        value: "г. Ростов-на-Дону, ул. Ларина, д.45, строение 4",
        tagIds: ["tag-address", "tag-stroenie-4"],
      },
    ],
  ...
  },
  {
    ...
    contacts: [
      {
        type: "telegram",
        value: "https://t.me/sr2_s5",
        label: "Telegram - Строение 5",
        tagIds: ["tag-chat", "tag-stroenie-5"],
      },
      {
        type: "address",
        value: "г. Ростов-на-Дону, ул. Ларина, д.45, строение 5",
        tagIds: ["tag-address", "tag-stroenie-5"],
      },
    ],
  ...
  },
  {
    ...
    contacts: [
      {
        type: "phone",
        value: "+7 (906) 425-93-86",
        label: "Консьерж - подъезд 1",
        tagIds: ["tag-konsierzh", "tag-stroenie-6", "tag-podezd-1"],
      },
      {
        type: "phone",
        value: "+7 (906) 425-94-39",
        label: "Консьерж - подъезд 2",
        tagIds: ["tag-konsierzh", "tag-stroenie-6", "tag-podezd-2"],
      },
      {
        type: "telegram",
        value: "https://t.me/sr2_s6",
        label: "Telegram - Строение 6",
        tagIds: ["tag-chat", "tag-stroenie-6"],
      },
      {
        type: "address",
        value: "г. Ростов-на-Дону, ул. Ларина, д.45, строение 6",
        tagIds: ["tag-address", "tag-stroenie-6"],
      },
    ],
  ...
  },
  {
    ...
    contacts: [
      {
        type: "phone",
        value: "+7 (905) 478-78-21",
        label: "Консьерж - подъезд 1",
        tagIds: ["tag-konsierzh", "tag-stroenie-7", "tag-podezd-1"],
      },
      {
        type: "phone",
        value: "+7 (905) 478-78-27",
        label: "Консьерж - подъезд 2",
        tagIds: ["tag-konsierzh", "tag-stroenie-7", "tag-podezd-2"],
      },
      {
        type: "telegram",
        value: "https://t.me/sr2_s7",
        label: "Telegram - Строение 7",
        tagIds: ["tag-chat", "tag-stroenie-7"],
      },
      {
        type: "address",
        value: "г. Ростов-на-Дону, ул. Ларина, д.45, строение 7",
        tagIds: ["tag-address", "tag-stroenie-7"],
      },
    ],
  ...
  // ===== ЗАСТРОЙЩИК МСК =====
  {
    ...
    contacts: [
      ...
      },
      {
        type: "phone",
        value: "+7 (928) 152-12-12",
        label: "Дежурный прораб",
        subtitle: "Игорь Стрекалов",
        hasWhatsApp: true,
      },
      {
        type: "address",
        value: "г. Ростов-на-Дону, пер. Доломановский, 70д, этаж 5",
        tagIds: ["tag-address"],
      },
      {
        type: "website",
        value: "https://msk-development.ru/projects/flats/serdce-rostova2",
        label: "Официальный сайт",
      },
      {
        type: "website",
        value: "https://forms.gle/umA7WHfsSs1HD6CV6",
        label: "Заявка на гарантийные работы",
      },
      {
        type: "whatsapp",
        value: "https://wa.me/+79188500955",
        label: "Официальный WhatsApp чат",
        tagIds: ["tag-chat"],
      },
      {
        type: "telegram",
        value: "https://t.me/msk_development",
        label: "Официальный Telegram чат",
        tagIds: ["tag-chat"],
      },
    ],
  ...
  // ===== СЛУЖБЫ ЖКХ =====
  {
    ...
    contacts: [
      {
        type: "website",
        value: "https://xn--80aaaf3bi1ahsd.xn--80asehdb/",
        label: "Квартплата.Онлайн",
        subtitle: "Регистрации показаний и оплата",
      },
      {
        type: "website",
        value: "https://play.google.com/store/apps/details?id=ru.sigma.gisgkh",
        label: "Госуслуги.Дом - Android",
      },
      {
        type: "website",
        value:
          "https://apps.apple.com/ru/app/%D0%B3%D0%BE%D1%81%D1%83%D1%81%D0%BB%D1%83%D0%B3%D0%B8-%D0%B4%D0%BE%D0%BC/id1616550510",
        label: "Госуслуги.Дом - iOS",
      },
    ],
  ...
  // ===== ДОМОФОНЫ VDome =====
  {
    ...
    contacts: [
      {
        type: "phone",
        value: "+7 (863) 310-02-26",
        label: "Диспетчерская",
        isPrimary: true,
        tagIds: ["tag-domofon", "tag-dispetcher"],
      },
      {
        type: "whatsapp",
        value: "https://wa.me/+79963530117?text=инструкция",
        label: "WhatsApp робот",
        subtitle: "Регистрация, инструкция",
        tagIds: ["tag-domofon"],
      },
      {
        type: "website",
        value: "https://play.google.com/store/apps/details?id=ru.mts.vdome.resident",
        label: "Приложение для Android",
        tagIds: ["tag-domofon"],
      },
      {
        type: "website",
        value: "https://apps.apple.com/ru/app/vdome/id1491163759",
  ...
  // ===== ВОДОКАНАЛ =====
  {
    ...
    contacts: [
      {
        type: "phone",
        value: "+7 (863) 309-09-09",
        label: "Передача показаний счетчиков",
        isPrimary: true,
      },
  ...
  // ===== ТНС-ЭНЕРГО =====
  {
    ...
    contacts: [
      {
        type: "website",
        value: "https://lk.rostov.tns-e.ru/",
  ...
  // ===== ТЕПЛОСЕРВИС ЮГ =====
  {
    ...
    contacts: [
      ...
      {
        type: "whatsapp",
        value: "https://wa.me/+79381009510",
        label: "WhatsApp, подать показания",
      },
    ],
    tagIds: ["tag-utilities"],
  },
  ...
  // ===== ИНТЕРНЕТ ПРОВАЙДЕРЫ =====
  {
    ...
    contacts: [
      {
        type: "phone",
        value: "+7 (863) 307-50-01",
        label: "Техническая поддержка",
        isPrimary: true,
      },
      {
        type: "website",
        value: "https://dealers.dom.ru/request/widget?domain=rostov&referral_id=1000181217",
        label: "Подключение (строения 1, 2)",
        subtitle: "В домах введено оборудование",
      },
      {
        type: "website",
        value: "https://forms.gle/FHVGqTtvkTWVWNfJ6",
        label: "Предварительная заявка (строения 3-9)",
  ...
  },
  {
    ...
    contacts: [
      ...
      {
        type: "website",
        value: "https://forms.gle/oQhTbvd7WKMaKVub6",
        label: "Заявка на подключение онлайн",
      },
      {
        type: "website",
        value: "https://rostov-na-donu.beeline.ru/customers/products/home/internet/",
        label: "Официальный сайт",
      },
    ],
    tagIds: ["tag-internet"],
