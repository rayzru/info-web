...
export function ResendVerificationForm() {
    ...
    return (
      <div className="flex flex-col items-center gap-6 text-center">
        ...
        <p className="text-muted-foreground">
          Если указанный адрес зарегистрирован и требует подтверждения,
          на него будет отправлено письмо со ссылкой.
        </p>
  ...
  return (
    <div className="flex flex-col gap-6">
      <h1 className="text-center text-lg font-bold uppercase tracking-[0.2em] text-foreground/90">
        Повторная отправка
      </h1>
      ...
      <div className="flex flex-col items-center gap-2 text-center">
        ...
        <p className="text-sm text-muted-foreground">
          Введите email, на который вы регистрировались, и мы отправим вам
