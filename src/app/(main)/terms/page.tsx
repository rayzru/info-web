    ...
    >
      ...
      <section id="community" className="mb-8 scroll-mt-6">
        ...
        <div className="text-muted-foreground space-y-3 text-sm leading-relaxed">
          ...
          <p>
            ...
            исключительно для целей соседского общения и не передавать её третьим лицам без согласия.
          </p>
        </div>
      </section>
      ...
      <section id="documents" className="mb-8 scroll-mt-6">
        ...
        <div className="text-muted-foreground space-y-3 text-sm leading-relaxed">
          ...
          <p>
            4.3. Загрузка документов является <strong>добровольной</strong> и не является обязательным
            требованием для использования Сервиса.
          </p>
          <p>
