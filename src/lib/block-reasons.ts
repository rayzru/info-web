...
export const RULES_VIOLATIONS = {
  "3.1": {
    ...
    description:
      "Размещение контента, нарушающего законодательство РФ или содержащего запрещённые материалы",
  },
  "3.2": {
    label: "Пункт 3.2",
    title: "Недостоверная информация",
    description:
      "Распространение заведомо ложной информации о жителях, управляющей компании или объектах комплекса",
  },
  "3.3": {
    label: "Пункт 3.3",
