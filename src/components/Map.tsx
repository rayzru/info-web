...
export const Map = ({ className }: Props) => {
    ...
    const [viewBox, setViewBox] = useState('300 300 3000 3000');
        ...
        <div className={ clsx(styles.mapWrapper, className) }>
            <svg viewBox={ viewBox } className={ styles.map } xmlns="http://www.w3.org/2000/svg">
                ...
                <g ref={ zoomRef } scale={ zoom }>
                    ...
                    <use className={ clsx(styles.str, styles.disabled) } href='/svg/plan/str-7.svg#str-7' x={ 1250 } y={ 690 } />
                    <use className={ clsx(styles.liter, styles.disabled) } href='/svg/plan/liter-b-back.svg#liter-b-back' x={ 1380 } y={ 675 } />
                    <use className={ clsx(styles.liter, styles.disabled) } href='/svg/plan/liter-b-mid.svg#liter-b-mid' x={ 1371 } y={ 1095 } />
                    <use className={ clsx(styles.liter, styles.disabled) } href='/svg/plan/liter-b-front.svg#liter-b-front' x={ 1365 } y={ 1475 } />
