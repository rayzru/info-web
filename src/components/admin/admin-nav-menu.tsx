    ...
    <header className="bg-card sticky top-0 z-50 border-b">
      <div className="container mx-auto flex h-14 items-center justify-between gap-4 px-4 md:px-6">
          ...
          <NavigationMenuList>
            {navGroups.map((group) => (
              <NavigationMenuItem key={group.title} hasSubmenu>
                <NavigationMenuTrigger className="h-9">{group.title}</NavigationMenuTrigger>
                <NavigationMenuContent>
        ...
        <a
          ...
          className="text-muted-foreground hover:bg-accent hover:text-accent-foreground hidden h-9 items-center gap-2 rounded-md px-3 text-sm font-medium transition-colors sm:flex"
            ...
            <div className="flex h-dvh max-h-full flex-col overflow-hidden">
              ...
              <nav className="min-h-0 flex-1 overflow-y-auto p-2">
                ...
                <div className="flex flex-col gap-1">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="hover:bg-accent flex h-11 items-center gap-3 rounded-md px-4 text-sm font-medium transition-colors"
                  >
              ...
              <div className="shrink-0">
                ...
                <div className="p-2">
                  <Button
                    variant="ghost"
                    className="text-destructive hover:bg-destructive/10 hover:text-destructive h-12 w-full justify-start gap-3"
                    onClick={() => signOut({ callbackUrl: "/" })}
                  >
