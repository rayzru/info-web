...
import { Building2, DoorOpen, Home, Car } from "lucide-react";
...
const StructureList = forwardRef<StructureListRef, StructureListProps>(
  function StructureList({ items, command }, ref) {
